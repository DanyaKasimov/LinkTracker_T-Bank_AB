...
import backend.academy.scrapper.liquibase.LiquibaseRunner;
...
public class JdbcDatabaseConfig {
    ...
    @Bean
    public LiquibaseRunner liquibaseRunner(LiquibaseConfig config) {
        return new LiquibaseRunner(config);
    }
