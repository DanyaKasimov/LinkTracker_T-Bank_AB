...
public class JdbcLinkRepository implements LinksRepository {
    ...
    private static final String SQL_FIND_BY_NAME_AND_CHAT =
            "SELECT id, name, chat_id FROM links WHERE name = ? AND chat_id = ?";
    ...
    private static final String SQL_FIND_ALL_BY_NAME =
            "SELECT l.id AS link_id, l.name AS link_name, c.id AS chat_id, c.user_id FROM links l JOIN chats c ON l.chat_id = c.id WHERE l.name = ?";
    ...
    private static final String SQL_DELETE_ALL = "DELETE FROM links WHERE id IN (:ids)";
    ...
    public Link save(Link link) {
        Long id = jdbc.queryForObject(
                SQL_SAVE, Long.class, link.getName(), link.getChat().getId());
    ...
    public void deleteAll(Collection<Link> links) {
        ...
        namedJdbc.update(SQL_DELETE_ALL, parameters);
    }
}
